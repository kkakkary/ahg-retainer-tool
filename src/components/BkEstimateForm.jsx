...
export default function BkEstimateForm({ savedFormData, onFormChange, onGenerated }) {
  ...
  function notifyChange(updates) {
    if (onFormChange) onFormChange({ clientName, totalDebt, discountedFee, fees, ...updates });
  }
  ...
  function handleClear() {
    ...
    notifyChange({ clientName: '', totalDebt: '', discountedFee: '', fees: initialFees });
  ...
  return (
    ...
    <div className="w-[520px] flex-shrink-0 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
        <h2 className="text-base font-semibold text-slate-800">Bankruptcy Fee Estimate</h2>
